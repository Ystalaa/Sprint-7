...
public class CourierAssert {
    ...
    @Step("Проверка ответа при неполных данных")
    ...
    @Step("Проверка ответа при регистрации под уже зарегистрированным логином")
    ...
    @Step("Проверка ответа при логине с неполными данными")
    ...
    @Step("Проверка ответа при логине с невалидными данными")
